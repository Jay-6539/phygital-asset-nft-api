            ...
            VStack(spacing: 0) {
                ...
                HStack(spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("\(myCheckIns.count + ovalCheckIns.count) Threads")
                            .font(.subheadline)
                ...
                if isLoading {
                    ...
                    VStack(spacing: 16) {
                        ...
                        Text("No Threads Yet")
                            .font(.headline)
                        Text("Start exploring and create threads!")
                            .font(.subheadline)
                            .foregroundColor(.secondary)
                    }
                    Spacer()
        ...
        Task {
            do {
                ...
                await MainActor.run {
                    ...
                    Logger.success("Loaded \(buildings.count) building threads and \(oval.count) oval office threads")
